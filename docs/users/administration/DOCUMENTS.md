...
1. Open `Documents`.
2. Use `Create Club or Required Document`.
3. Select `Club Document`.
4. Add a title, optional description, optional resource, and file.
...
1. Open `Documents`.
2. Use `Create Club or Required Document`.
3. Select `Required Reading`.
4. Add the title, description, optional resource, and file.
5. Select `Create Document`.
...
1. Open `Documents`.
2. Use `Create Required Member Document`.
3. Add a title and description.
4. Choose whether the requirement is organization-wide or linked to a resource.
5. Choose whether it is enforced for booking.
6. Choose whether members can provide expiration dates.
7. Select `Create Requirement`.
